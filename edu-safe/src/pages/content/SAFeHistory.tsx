  ...
  return (
    <div>
      <p>
        ...
        muitas empresas grandes queriam usar os benefícios do "jeito ágil" de
        trabalhar (como flexibilidade e entregas rápidas, comuns no Scrum ou
        Kanban), mas tinham dificuldade em fazer isso com muitas equipes ao
        mesmo tempo .
      </p>
      <p>
        Pense assim: construir uma casa pode ser feito por uma equipe pequena e
        ágil . Mas construir um condomínio inteiro, com vários prédios, exige
        muito mais coordenação, planejamento e comunicação entre as diversas
        equipes de construção. O SAFe veio para resolver justamente esse
